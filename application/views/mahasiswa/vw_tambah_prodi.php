                ...
                <div class="card-body">
                    <form action="<?= base_url('Prodi/upload'); ?>" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="ruangan" class="form-control" id="nim" placeholder="Ruangan">
                        </div>
                        <div class="form-group">
                            <label for="jenis kelamin">Jurusan</label>
                            <input type="text" name="jurusan" class="form-control" id="nim" placeholder="Jurusan">
                        </div>
                        <div class="form-group">
                            <label for="email">Akreditasi</label>
                            <select name="akreditasi" id="prodi" class="form-control">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="nama_kaprodi" class="form-control" id="nim"
                                placeholder="Nama Kaprodi">
                        </div>
                        <div class="form-group">
                            <label for="asal sekolah">Tahun Berdiri</label>
                            <input type="text" name="tahun_berdiri" class="form-control" id="asal_sekolah"
                                placeholder="Tahun Berdiri">
                        </div>
                        <div class="form-group">
                            <label for="no_hp">Output Lulusan</label>
                            <input type="text" name="output_lulusan" class="form-control" id="asal_sekolah"
